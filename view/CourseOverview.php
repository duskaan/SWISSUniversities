...
<div class="container">
    ...
    global $courses;
    if(empty($courses)){
        echo("<h3 style=\"padding-bottom: 100px\">You have no records yet. Press here to add a course: <a class=\"btn btn-default\" role=\"button\" href=\"course-create\"  > <i class=\"fa fa-plus-square-o\"></i></a></h3> ");
        }else{
    ...
    <div class="btn-group" role="group" style="padding-bottom: 100px" >
